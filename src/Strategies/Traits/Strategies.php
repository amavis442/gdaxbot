...
trait Strategies
{
     ...
     */
    private function ema_maker(array $data, int $period, bool $prior = false)
    {
     ...
     * @return mixed
     */
    private function sma_maker(array $data, int $period, bool $prior = false)
    {
     ...
     * @return mixed
     */
    private function ma_maker(array $data, int $period, bool $prior = false)
    {
     ...
     * @return int
     */
    public function bowhead_sar_stoch(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();

        $fsar   = $indicators->fsar($data); // custom sar for forex
     ...
     * @return int
     */
    public function bowhead_awesome_macd(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
        $ao         = $indicators->awesome_oscillator($data);
     ...
     * @return int
     */
    public function bowhead_adx_smas(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_rsi_macd(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();

        $rsi      = $indicators->rsi($data, 14); // 19 more accurate?
     ...
     * @return int
     */
    public function bowhead_sar_rsi(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_stoch_adx(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     *         opposite direction
     */
    public function bowhead_cci_scalper(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_ema_scalper(array $data, bool $return_full = false)
    {
     ...
     * @return int
     */
    public function bowhead_ema_stoch_rsi(array $data, bool $return_full = false)
    {
     ...
     * @return int
     */
    public function bowhead_double_volatility(array $data, bool $return_full = false)
    {
     ...
     * @return int
     */
    public function bowhead_adx_momentum(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return array|int
     */
    public function bowhead_base_150(array $data, bool $return_full = false)
    {
        ...
        if ($ma6 > $ma150 && $ma6 > $ma365 && $ma35 > $ma150 && $ma35 > $ma365 && $ma6p < $ma150 && $ma6p < $ma365 && $ma35p < $ma150 && $ma35p < $ma365) {
            $return['side']     = 'long';
     ...
     * @return int
     */
    public function bowhead_breakout_ma(array $data, bool $return_full = false)
    {
        $sma20_low = $this->sma_maker($data['low'], 20);
     ...
     * @return int
     */
    public function bowhead_sar_awesome(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_cci_ema(array $data, bool $return_full = false)
    {
     ...
     * @return int
     */
    public function bowhead_bband_rsi(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();

        $rsi    = $indicators->rsi($data, 11);
        $bbands = $indicators->bollingerBands($data, 20);
     ...
     * @return int
     */
    public function bowhead_ema_adx_macd(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
        ...
        $macd = $indicators->macd($data, 5, 10, 4);
     ...
     * @return int
     */
    public function bowhead_mov_avg_sar(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_momentum(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function bowhead_sma_stoch_rsi(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function bowhead_sar_sma(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
        $price      = array_pop($data['close']);
        $sar        = $indicators->fsar($data);
     ...
     *  @return int
     */
    public function bowhead_ema_adx(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function bowhead_trend_bounce(array $data, bool $return_full = false)
    {
        // custom bbands
     ...
     *  @return int
     */
    public function bowhead_5th_element(array $data, bool $return_full = false)
    {
        $indicators = new Indicators();
        $macd_base  = $indicators->macd($data);
     ...
     *  @return int
     */
    public function bowhead_powerranger(array $data, bool $return_full = false)
    {
     ...
     *  @return int
     */
    public function bowhead_famamama(array $data, bool $return_full = false)
    {
